...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_COMPANION_RST},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_COMPANION_AVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_COMPANION_DVDD},
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
#if defined(S5KGW3_MIPI_RAW)
	{
		...
		{
			{RST, Vol_Low, 0},
			{COMPANION_RST, Vol_Low, 0},

			{DOVDD, Vol_1800, 0},
			{DVDD, Vol_1050, 0},
			{AFVDD, Vol_2800, 1},

			{COMPANION_DVDD, Vol_1000, 0},
			{COMPANION_AVDD, Vol_High, 2},

			{AVDD, Vol_2800, 0},

			{SensorMCLK, Vol_High, 1},
			{RST, Vol_High, 1},
			{COMPANION_RST, Vol_High, 2},
		},
	},
#endif
