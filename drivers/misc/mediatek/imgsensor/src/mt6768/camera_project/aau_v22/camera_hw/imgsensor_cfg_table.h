...
enum IMGSENSOR_HW_PIN {
	...
	IMGSENSOR_HW_PIN_OIS_VDD_LDO_EN,
	IMGSENSOR_HW_PIN_OIS_MCU_LDO_EN,
	IMGSENSOR_HW_PIN_OIS_MCU_RST,
...
/* For OIS & MCU */
#define	OIS_VDD  IMGSENSOR_HW_PIN_OIS_VDD_LDO_EN
#define	OIS_MCU  IMGSENSOR_HW_PIN_OIS_MCU_LDO_EN
#define	MCU_RST  IMGSENSOR_HW_PIN_OIS_MCU_RST
