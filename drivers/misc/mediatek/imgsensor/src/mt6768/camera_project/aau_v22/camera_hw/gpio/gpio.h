...
enum GPIO_CTRL_STATE_CAM  {
	...
	GPIO_CTRL_STATE_LDO_OIS_VDD_LDO_EN_H,
	GPIO_CTRL_STATE_LDO_OIS_VDD_LDO_EN_L,
	GPIO_CTRL_STATE_LDO_OIS_MCU_LDO_EN_H,
	GPIO_CTRL_STATE_LDO_OIS_MCU_LDO_EN_L,
	GPIO_CTRL_STATE_LDO_OIS_MCU_RST_H,
	GPIO_CTRL_STATE_LDO_OIS_MCU_RST_L,
