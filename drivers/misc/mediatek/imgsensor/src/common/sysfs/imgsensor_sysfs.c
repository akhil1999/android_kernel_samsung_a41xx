...
const struct rom_crosstalk_cal_addr *imgsensor_get_crosstalk_cal_by_sensor_idx(int sensor_idx)
{
	int position = map_position(sensor_idx);
	...
	return rom_addr->crosstalk_cal_addr;
}

bool imgsensor_get_crosstalk_addr_by_sensor_idx(int sensor_idx, int *crosstalk_addr, int *crosstalk_size)
{
	const struct rom_crosstalk_cal_addr *crosstalk_cal = imgsensor_get_crosstalk_cal_by_sensor_idx(0);

	if (crosstalk_cal == NULL) {
		pr_err("[%s] crosstalk_cal is NULL", __func__);
		return false;
	}

	*crosstalk_addr = crosstalk_cal->rom_crosstalk_addr;
	*crosstalk_size = crosstalk_cal->rom_crosstalk_size;

	return true;
}

bool imgsensor_get_ggc_addr_by_sensor_idx(int sensor_idx, int *ggc_addr, int *ggc_size)
{
	const struct rom_crosstalk_cal_addr *crosstalk_cal = imgsensor_get_crosstalk_cal_by_sensor_idx(0);
	...
	*ggc_addr = crosstalk_cal->rom_ggc_addr;
	*ggc_size = crosstalk_cal->rom_ggc_size;
