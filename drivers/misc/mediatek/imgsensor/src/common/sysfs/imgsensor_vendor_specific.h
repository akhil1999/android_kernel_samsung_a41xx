...
struct rom_crosstalk_cal_addr {
	int32_t rom_crosstalk_addr; //HW remosaic: XTC, SW remosaic: XTC + GGC
	int32_t rom_crosstalk_size;
	int32_t rom_ggc_addr;       //GGC (for HW remosaic)
	int32_t rom_ggc_size;
};
...
/***** Crosstalk Cal Data *****/
	const struct rom_crosstalk_cal_addr *crosstalk_cal_addr;
