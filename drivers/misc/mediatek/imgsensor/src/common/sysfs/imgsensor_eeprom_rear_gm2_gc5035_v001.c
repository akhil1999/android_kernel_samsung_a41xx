...
const struct rom_crosstalk_cal_addr rear_gm2_crosstalk_addr = {
	.rom_crosstalk_addr = 0x09D0,
	.rom_crosstalk_size = (0x2A95 - 0x09D0 + 1),
	.rom_ggc_addr       = 0x2A96,
	.rom_ggc_size       = (0x2AF1 - 0x2A96 + 1),
};
...
const struct imgsensor_vendor_rom_addr rear_gm2_gc5035_cal_addr = {
	...
	.crosstalk_cal_addr                     = &rear_gm2_crosstalk_addr,
