...
#define FRONT_HI2021Q_MAX_CAL_SIZE (0xCFC)
...
#define FRONT_HI2021Q_CONVERTED_MAX_CAL_SIZE (0x0800)
#define FRONT_HI2021Q_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define FRONT_HI2021Q_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)
...
const struct imgsensor_vendor_rom_addr front_hi2021q_cal_addr = {
	...
	.rom_header_module_id_addr              = 0x3E,
